/* Molten-metal shader backdrop, from ReactBits (reactbits.dev/backgrounds/molten-metal),
   adapted: WebGL2 failure bails quietly (the CSS wash behind it remains the backdrop),
   mouse drift reads from window because the canvas sits under the hero scrim and never
   receives pointer events itself, and reduced motion holds a single rendered frame. */
